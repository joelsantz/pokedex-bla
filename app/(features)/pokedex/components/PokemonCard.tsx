...
export function PokemonCard({ pokemon }: PokemonCardProps) {
  return (
    <Link
      ...
      className="rounded-[28px] border border-slate-100 bg-white/90 p-5 shadow-lg shadow-slate-200/70 transition hover:-translate-y-1 hover:shadow-2xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--primary)]"
    >
      <article>
